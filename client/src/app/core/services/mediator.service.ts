...
export class MediatorService {
  ...
  private url_templates = {
    "dimension_values": "/mediator/list-parameter-values/", // /layer_id/param_name
    "getData": "/mediator/get-data",
    "getTimeSeries": "/mediator/get-data",
    "getDepthProfile": "/mediator/get-data",
    "getAreaData": "/mediator/get-data"
  }

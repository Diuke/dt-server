...
from twin_earth.worldpop import wrapper as worldpop_wrapper
from twin_earth.geoportale_nazionale import wrapper as geoportale_wrapper
from twin_earth.copernicus_atmosphere_service import wrapper as cams_wrapper
...
def update_layers(request):
    ...
    for layer in db_layers:
        if layer.type == Layer.LayerType.WMS:
            if layer.enabled:
                if layer.source == 'Copernicus Marine Services' or layer.source == 'Copernicus Atmosphere Monitoring Service':
